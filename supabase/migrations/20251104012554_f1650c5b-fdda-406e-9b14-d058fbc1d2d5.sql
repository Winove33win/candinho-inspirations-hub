...
DROP POLICY IF EXISTS "Users can view their own verification" ON public.professional_verifications;
DROP POLICY IF EXISTS "Users can insert their own verification" ON public.professional_verifications;
DROP POLICY IF EXISTS "Users can update their pending verification" ON public.professional_verifications;
DROP POLICY IF EXISTS "Admins can view all verifications" ON public.professional_verifications;
DROP POLICY IF EXISTS "Admins can update all verifications" ON public.professional_verifications;
...
DROP POLICY IF EXISTS "Professionals can view prices" ON public.product_prices;
DROP POLICY IF EXISTS "Admins can manage prices" ON public.product_prices;
...
DROP POLICY IF EXISTS "Users can view their verification files" ON storage.objects;
...
DROP TRIGGER IF EXISTS update_professional_verifications_updated_at ON public.professional_verifications;
